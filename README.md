...
Because some inputs depend on external data access credentials and BigQuery permissions, full replication may require a valid `basedosdados` billing project and access to the underlying public datasets.
...
.
├── README.md
├── Thesis_Main/            # Main LaTeX thesis files and text
├── FiguresFinal/           # Exported figures and event-study plots
├── TablesFinal/            # Regression tables and summary tables
├── DocumentationFinal/     # Audit logs, codebooks, appendix exports
├── R/                      # Analysis scripts
└── data_dictionary/        # Optional reference files / coding appendices
